$( document ).ready(function() {
	...
	$.get( api_url+"get_doctor_details.php", {func: "nurse_provided_service"})
	 	...
	 	for(var key in data.data)
	 	{
			...
			html_str += 		'<img src="http://www.demo.ritzcybernetics.com/health_app/images/nurse_service.png"  class="img-reponsive img-rounded" />';
			html_str +=	    '</span> &nbsp;';
...
{
	window.open("http://www.demo.ritzcybernetics.com/health_app/doctor-prescription?" + $("#base_pres").val(), '_system'); 
	return false;
}