...
$("#imageCapture").click(function(){
	...
	function cameraSuccess(imageUri) {
        ...
        params.fileName = "pres_"+app_id+".jpg";
	...
	fileChooser.open( function(file) {
		...
		window.FilePath.resolveNativePath(
			...
			function(orgFile){
		        ...
		        params.func = "save_prescription_browse";
...
{
	window.open("http://www.demo.ritzcybernetics.com/health_app/doctor-prescription.php?" + base_pres, '_system'); 
	return false;
}